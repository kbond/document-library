...
use Zenstruck\Document\Bridge\Doctrine\Persistence\MappingConfigProvider;
...
final class ObjectDocumentLoaderTest extends TestCase
{
    ...
    public function can_load_documents_for_entity(): void
    {
        ...
        $loader = new ObjectDocumentLoader($registry, new MappingConfigProvider($this->doctrine()));
