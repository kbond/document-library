...
final class ChecksumNamerTest extends TestCase
{
    ...
    public function generate_name(): void
    {
        ...
        $this->assertSame('9a0364b9e99bb480dd25e1f0284c8555', $namer->generateName(self::$library->store('foo/bar', 'content')));
        $this->assertSame('9a0364b9e99bb480dd25e1f0284c8555.txt', $namer->generateName(self::$library->store('foo/bar.txt', 'content')));
        $this->assertSame('9a0364b9e99bb480dd25e1f0284c8555.txt', $namer->generateName(self::$library->store('foo/bar.TxT', 'content')));
        $this->assertSame('040f06fd774092478d450774f5ba30c5da78acc8.txt', $namer->generateName(self::$library->store('foo/bar.TxT', 'content'), ['alg' => 'sha1']));
        $this->assertSame('040f06f.txt', $namer->generateName(self::$library->store('foo/bar.TxT', 'content'), ['alg' => 'sha1', 'length' => 7]));
    }
}
